...
public class BooksCheckedOutView extends View {
    // other private data
    private final int labelWidth = 120;
    private final int labelHeight = 25;

    // GUI components
    protected Button listBooksCheckedOutButton;
    ...
    protected String keyToSendWithData = "BooksCheckedOutData";

    // constructor for this class -- takes a model object
    //----------------------------------------------------------
    public BooksCheckedOutView(IModel Book){
        super(Book, "BooksCheckedOutView");
        ...
        keyToSendWithData = "BooksCheckedOutData";
    ...
    private VBox createFormContents()
    {
        ...
        listBooksCheckedOutButton = new Button("List All Books Checked Out");
        listBooksCheckedOutButton.setFont(Font.font("Comic Sans", FontWeight.NORMAL, 14));
        listBooksCheckedOutButton.setOnAction((ActionEvent e) -> {
            clearErrorMessage();
            Properties props = new Properties();
            myModel.stateChangeRequest("BooksCheckedOutData", props);
        });
        listBooksCheckedOutButton.addEventHandler(MouseEvent.MOUSE_ENTERED, (MouseEvent e) -> {
            listBooksCheckedOutButton.setEffect(new DropShadow());
        });
        listBooksCheckedOutButton.addEventHandler(MouseEvent.MOUSE_EXITED, (MouseEvent e) -> {
            listBooksCheckedOutButton.setEffect(null);
        });
        listBooksCheckedOutButton.setScaleX(1.7);
        listBooksCheckedOutButton.setScaleY(1.7);
        reportCont.getChildren().add(listBooksCheckedOutButton);
        ...
        doneButton.setOnAction((ActionEvent e) -> {
            clearErrorMessage();
            myModel.stateChangeRequest("CancelListBooks", null);
        });
