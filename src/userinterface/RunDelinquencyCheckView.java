...
public class RunDelinquencyCheckView extends View {
    ...
    // GUI components
    protected Button runDelCheckButton;
    ...
    //----------------------------------------------------------
    public RunDelinquencyCheckView(IModel Book) {

        super(Book, "RunDelinquencyCheckView");
        ...
        keyToSendWithData = "DelinquencyData";
    ...
    private VBox createFormContents()
    {
        ...
        runDelCheckButton.setFont(Font.font("Comic Sans", FontWeight.NORMAL, 14));
        runDelCheckButton.setOnAction((ActionEvent e) -> {
            clearErrorMessage();
            Properties props = new Properties();
            myModel.stateChangeRequest(keyToSendWithData, props);
        });
        runDelCheckButton.addEventHandler(MouseEvent.MOUSE_ENTERED, (MouseEvent e) -> {
            runDelCheckButton.setEffect(new DropShadow());
        });
        runDelCheckButton.addEventHandler(MouseEvent.MOUSE_EXITED, (MouseEvent e) -> {
            runDelCheckButton.setEffect(null);
        });
        runDelCheckButton.setScaleX(1.65);
        runDelCheckButton.setScaleY(1.65);
        reportCont.getChildren().add(runDelCheckButton);
        ...
        doneButton.setOnAction((ActionEvent e) -> {
            clearErrorMessage();
            myModel.stateChangeRequest("CancelRunDelCheck", null);
        });
