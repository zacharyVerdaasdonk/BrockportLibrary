 ...
 * by every Impresario client in order to keep track of which control
...
public abstract class Registry
{
	...
	protected Hashtable<Object, Object> mySubscribers;
	...
	public Registry(String classname) 	// the name of the class that contains this Registry, debug only
	{
		...
		mySubscribers = new Hashtable<Object, Object>();
	...
	public void subscribe(String key, Object subscriber)
	{
		...
		if(mySubscribers.containsKey(key) == true)
		{
			...
			if(tempObj instanceof Vector)
			{
				...
				Vector<Object> tVect = (Vector<Object>)tempObj;
				tVect.addElement(subscriber);
			}
