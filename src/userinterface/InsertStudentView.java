...
public class InsertStudentView extends View {
    ...
    //protected ComboBox borrowerStatus; //Either "Good Standing" or "Delinquent"
    protected TextField dateOfLastBorrowerStatus;
    protected TextField dateOfRegistration;
    protected TextArea notes;
    //protected ComboBox status; //Either "Active" or "Inactive"
    ...
    //----------------------------------------------------------
    public InsertStudentView(IModel Student) {

        super(Student, "InsertStudentView");
    ...
    protected VBox createFormContents() {
        ...
        Text prompt = new Text("Enter All Student Borrower Information");
                    ...
                    if(lastNameText.length() != 0 && lastNameText.length() < 21) {
                        ...
                        if (phoneText.length() < 13) {
                            ...
                            if (emailText.length() < 31) {
                                ...
                                props.setProperty("BorrowerStatus", "Good Standing");
