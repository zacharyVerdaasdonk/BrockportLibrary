...
public class StudentCollectionView extends View {
    ...
    //--------------------------------------------------------------------------
    public StudentCollectionView(IModel mst){
        super(mst, "StudentCollectionView");
        ...
        populateFields();
        tableOfStudents.getSelectionModel().select(0); //autoselect first element
    ...
    private VBox createFormContent() {
        ...
        tableOfStudents.setOnMousePressed((MouseEvent event) -> {
        ...
        doneButton.setOnAction((ActionEvent e) -> {
            clearErrorMessage();
            myModel.stateChangeRequest("CancelStudentList", null);
        });
    ...
    {
        StudentTableModel selectedItem = tableOfStudents.getSelectionModel().getSelectedItem();

        if(selectedItem != null) {
            String selectedId = selectedItem.getBannerId();

            myModel.stateChangeRequest("StudentSelected", selectedId);
        }
    }
