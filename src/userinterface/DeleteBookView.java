...
public class DeleteBookView extends View {
    ...
    protected VBox createFormContents() {
        ...
        Text prompt = new Text("Are you sure you want to delete this book?");
        ...
        Text autLabel = new Text(" Author : ");
        autLabel.setFont(myFont);
        autLabel.setWrappingWidth(150);
        autLabel.setTextAlignment(TextAlignment.RIGHT);
        grid.add(autLabel, 0, 3);
        grid.add(author = new TextField(), 1, 3);
    ...
    public void populateFields() {
        ...
        String autText = (String) myModel.getState("Author1");
        author.setText(autText);
